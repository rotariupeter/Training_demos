...
public class JsonToClass {
    ...
    public static void main(String[] args) throws IOException {
        URL url = new File("colleges5.json").toURI().toURL();
        String packageName = "com.training.petru.jsonParser";
        String basePath = "src/main/resources";
        File outputPojoDirectory = new File(basePath + File.separator + "convertedPojo");
        outputPojoDirectory.mkdirs();

        convertJsonToJavaClass(url,outputPojoDirectory,packageName,"Colleges");
